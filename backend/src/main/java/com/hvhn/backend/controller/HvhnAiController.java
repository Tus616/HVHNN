...
public class HvhnAiController {
    ...
    @PostMapping("/process")
    public ResponseEntity<Object> processAi(@RequestBody Map<String, Object> payload, @AuthenticationPrincipal User user) {
        ...
        Map<String, Object> result = aiService.process(payload);
